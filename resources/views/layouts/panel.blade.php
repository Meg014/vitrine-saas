...
<div class="min-h-screen lg:flex">
    ...
    <aside :class="menu ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-40 flex w-72 flex-col bg-slate-950 p-5 text-white transition-transform lg:static lg:translate-x-0">
        ...
        @php($links = [['Visão geral','dashboard','⌂'],['Produtos','products.index','◇'],['Categorias','categories.index','▦'],['Atributos','attributes.index','✦'],['Estoque','inventory.index','▤'],['Pedidos','pedidos','▤'],['Clientes','customers.index','♙'],['Mensagens','messages.index','✉'],['Aparência','aparencia','✦'],['Configurações','configuracoes','⚙']])
